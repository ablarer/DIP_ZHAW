...
if imgName == "chessboard_perspective.jpg":
    points_d = np.array([[380, 40], [940, 170], [710, 670], [50, 420]])    # TODO: Additional Points go here
    points_u = np.array([[0, 0], [200, 0],[200, 200],[0, 200]])# TODO: Coordinates of undistorted Points go here

# draw markings on the source image
for i, pts in enumerate(points_d):
...
x = np.linalg.solve(a, b, c, d, e, f, g, h)
...
h = get_homography_matrix(points_d, points_u)
